---
layout: post
title: "When and How to Use AI: A Framework for Reflection"
date: 2026-06-16
latex: true
mathjax: true
comments: true
...
1. Instructions on how to approach or complete a task "by hand" (without AI). 
2. Code to complete a task rather than executing the task directly.
3. Planning or organizational support to work through a task or project. 
4. Suggestions of papers to read to learn more about a topic. 
...
This question is important for working with AI because, at least in their current form, LLM tools are fundamentally fallible, sometimes in non-obvious ways. For many research tasks, a key concern is [hallucination](https://en.wikipedia.org/wiki/Hallucination_(artificial_intelligence)), wherein an AI tool might invent facts or citations, sometimes confidently asserting claims that are completely wrong. 
...
{% include image-pair.html src1="/figs/2026-06-16-ai-use-framework/latex_code.jpg" alt1="LaTeX source code for a research table" src2="/figs/2026-06-16-ai-use-framework/compiled_table.jpg" alt2="The compiled, professionally formatted table" %}
</div>
</html>
...
{% include image.html src="/figs/2026-06-16-ai-use-framework/example_interface.jpg" alt="Data-labeling interface comparing Uber and Lyft ride options for the same trip" %}
