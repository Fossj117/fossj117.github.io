...
While this approach can be motivating and enjoyable, it also has limitations. There are lots of interesting and rewarding projects that can only be completed with sustained focus and commmitment; focus allows for more completely exploring and refining an idea. Further, many projects involve some moments of frustration or annoyance at some point or another -- some tasks that I feel resistant towards completing. It can be difficult to work through these moments of resistance under the excitement-oriented approach. 
...
With that in mind, I am doing some experiments in creative consistency. Here is one experiment. Today is Sunday. Each day this week, I am going to make one generative drawing in a series. There will be seven drawings in the series, and they will all be made using the same (or a similar) process. The process I want to explore is involves combining generative art and the axidraw with water-soluble fountain pen ink and watercolors. 

## Design

I have two sheets of leftover 9x12" watercolor paper; I will divide them into 4x6" rectangles for the drawings. The drawings will have a 1/2" border, so the main drawings will be 3x5". I have a simple concept in mind for the generative drawings. 

Here is the plan: 

1. Split the canvas into an array of squares. 
2. Create a "fracture" from top to bottom of the canvas. 
3. Fill squares in different ways in relation to their distance from the fracture. 

I want to pair the machine drawing with some hand water-coloring, so I will go in with that at the end.
