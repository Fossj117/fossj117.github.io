---
layout: post
title: "Governing the Laundry Room: Micro-scale Organizing with Polis"
date: 2026-03-11
latex: true
mathjax: true
comments: true
...
To start a conversation, I used a simple "deliberative technology" called [Polis](https://compdemocracy.org/Polis/). If you are not familiar with Polis, it is a tool that allows conversation participants to anonymously post and vote on statements about a topic. The tool then helps group and synthesize results from the voting.
...
{% include image.html src="/figs/2026-03-11-laundry-room-polis/flyer.jpg" alt="flyer posted in the laundry room" %}
...
To this end, I generated [a polis report](https://pol.is/report/r9p5hee74s9jmeuyxuef8) and created a new flyer linking folks to it. Here is what the main results flyer looked like: 

{% include image.html src="/figs/2026-03-11-laundry-room-polis/results_are_in.jpg" alt="Results posted" %}
...
{% include image.html src="/figs/2026-03-11-laundry-room-polis/summary_of_results_p1.jpg" alt="Summary of results page 1" width="100%" %}
{% include image.html src="/figs/2026-03-11-laundry-room-polis/summary_of_results_p2.jpg" alt="Summary of results page 2" width="100%" %}
...
{% include image.html src="/figs/2026-03-11-laundry-room-polis/white_board.jpg" alt="Out of order signs" %}

{% include image.html src="/figs/2026-03-11-laundry-room-polis/out_of_order_signs.jpg" alt="Whiteboard" %}
...
{% include image.html src="/figs/2026-03-11-laundry-room-polis/whiteboard_in_use.jpg" alt="Laundry room whiteboard in use" %}
...
{% include image.html src="/figs/2026-03-11-laundry-room-polis/magnetic_out_of_order_sign.jpg" alt="Magnetic out of order sign in use" %}
...
{% include image.html src="/figs/2026-03-11-laundry-room-polis/lost_and_found.jpg" alt="Laundry room lost and found" %}
...
If you want to facilitate a deliberative conversation in your own laundry room (or in another community), you can start a Polis conversation [here](https://pol.is/home2). Sign in and click "Create a new conversation". Here are the configuration settings that I used: 
...
* **Seed Statements**: Here is the complete list of seed statements that I used (also available as a [CSV download](/files/laundry_room_polis_seed_statements.csv) for easy import into your own Polis conversation): 
...
Finally, I've uploaded all my flyers and assets to a public Google drive folder [here](https://drive.google.com/drive/folders/169o70t9xHVN68zzUgaMRs3K9CXe8Ztpt?usp=sharing). Feel free to modify or reuse as you see fit.