...
<div>
  <img src="/figs/2024-05-11-next-bike/bombora_FP.jpg" alt="bombora_FP" style="display: block; margin-left: auto; margin-right: auto; max-width: 75%;">
</div>

After some waffling about pulling the trigger here, I finally went for it, and at long last the Bombora is built! In this update I'll post a few early reflections on the setup. 

* Overall, the bike feels really nice to ride. I love that it can both do some gravel and move pretty quickly on pavement. I haven't had a bike with much speed in a while, and so that's a nice change. I sometimes try tailing lycra road bike folks on the bike trail, and the Bombora can largely keep up. 
* The drivetrain overall is a highlight; it feels really smooth and efficient, like all the power that I am putting in is going right into the system. I imagine this feeling is from some combination of things, maybe mostly the crankset and bottom bracket. The hubs probably help too. It actually makes me interested to try a fixed gear with nicer components like this; I can imagine it feels really nice and connected. 
* The front end is more stable than I was expecting or am used to. I guess this is from the trail. According to BikeInsights, the trail on the Bombora is 75.5mm which is "high". Regardless, it's an obvious contrast with my track bike and my Bridgestone in terms of how the front end feels. I don't know that I have a strong preference here; I guess the stability is kind of nice when moving fast in a straight line. In the city, it's nice to have some more twitch for dodging cars and pedestrians and such. I will need to think about it more on gravel. 
* Aesthethically, I think I like the set up, though am maybe still getting used to it. I think it's objectively quite "nice" and fits the vision; however, still figuring out if/how it fits with my personal style. It's interesting how things can be different in person vs. in the abstract. If I did it again, I might go for something lugged and a bit more subtle in color and vibe. Someday I will probably get a Rivendell. Still, I like the Bombora a lot and think it is unique. 
* My main pet peeve with the setup right now is that the rear hub is a bit loud for me. I didn't think about this when choosing, but in retrospect it's something that I do care about. I don't like the whole "loud hub" thing. I want my bike to ride quietly and elegantly, not create a scene and draw attention or whatever. Some people on the internet suggest it's possible to quiet a hub down; there's also some very silent hubs around, so maybe we will swap that out someday. That said, I might also get used to it. The hubs have already gotten a bit quieter I think.
* Overall, I think I am quite hooked on gravel and dirt after my first few rides. It's just so lovely to be able to be out in the forest on a bike, often away from people. It's just really beautiful. 

<div>
  <img src="/figs/2024-05-11-next-bike/bombora_trail.jpg" alt="bombora_trail" style="display: block; margin-left: auto; margin-right: auto; max-width: 75%;">
</div>
...
[Interesting interview](https://www.youtube.com/watch?v=f4hyzkJGONA&ab_channel=PathLessPedaled) with Jeff Frane.
