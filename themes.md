...
* *Sewing*. Especially patchwork and mending. [[1]](https://jeffreyfossett.com/notes.html#41)
...
* *Conflict and cooperation*. Conflict mediation and bridging, especially online. [[1]]({% post_url 2025-08-11-bridging-bot-media %}) [[2]]({% post_url 2025-05-10-notes-on-deutsch %}) 
* *Large language models*. LLMs are fun to experiment with for productive and non-productive ends. [[1]]({% post_url 2026-01-18-claude-code-reflection %}) [[2]]({% post_url 2024-01-27-mapping-colors-emotions-with-llms %}) [[3]]({% post_url 2024-01-05-gpt-experiments %})
* *(Economic) expertise*. How do we create facts? How do expertise and democracy fit together? [[1]]({% post_url 2026-01-30-ways-of-knowing %}) [[2]]({% post_url 2023-05-01-sts-performativity-in-economics %})
